        ...
        <div className="space-y-2">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.86-.03 3.03.79 4.08.79 1.07 0 2.44-.96 4.32-.81 1.74.1 2.95.74 3.76 1.94-3.32 1.83-2.77 6.6.28 7.85-.53 1.14-1.17 2.27-2.11 3.81M12.18 2.25c-.67 2.13 1.28 4.36 2.89 3.91.36-2.13-1.24-4.35-2.89-3.91z"/>
            </svg>
